...
class MLAlgoritham(models.Model):
    '''
...
class MLAlgorithamStatus(models.Model):
    '''
    ...
    created_at = models.DateTimeField(auto_now_add=True, blank=True)
    parent_mlalgoritham = models.ForeignKey(MLAlgoritham, on_delete=models.CASCADE, related_name="status")
...
class MLRequest(models.Model):
    ...
    created_at = models.DateTimeField(auto_now_add=True, blank=True)
    parent_mlalgorithm = models.ForeignKey(MLAlgoritham, on_delete=models.CASCADE)
